...
if dup:
    ...
    axarr = [1,2]
else: fig,axarr = plt.subplots(1,3,figsize=(24,7),sharey=True)
...
for ax in axarr:
    ...
    if dup: ax.errorbar(fluxdata[filt]['LMASS'],fluxdata[filt]['av'],yerr=fluxdata[filt]['dav1'],color='grey',marker='o',ms=4,lw=0.5,ls='None',zorder=3)
        ...
        ax.errorbar(fluxdata[somelow]['LMASS'],fluxdata[somelow]['av'],yerr=fluxdata[somelow]['dav1'],color='grey',marker='o',ms=4,lw=0.5,ls='None')
        ax.errorbar(fluxdata[filt]['LMASS'],fluxdata[filt]['av'],yerr=fluxdata[filt]['dav1'],color=color,marker='o',ms=4,lw=0.5,ls='None')
